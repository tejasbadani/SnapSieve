...
//                        let postObject = Post(img1URL: url1_1, img2URL: url2_2, votes1: votes1, votes2: votes2 , postID : postID , username : userNameFinal,caption: caption,profileURL : url3 , coolC : coolCount , litC : litCount , heartC : heartCount , flowersC : flowersCount , confusedC : confusedCount , userID : userID , isVotingEnabled : isVoteEnabled)
