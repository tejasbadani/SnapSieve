...
extension FeedVC1 : GalleryControllerDelegate{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Camera1" {
            ...
            let uploadVC = navController.topViewController as! UploadImagesVC
            uploadVC.img1 = imagesE.first
            uploadVC.img2 = imagesE.last
        }
        ...
        if segue.identifier == "viewUser"{
            ...
            viewUser.userName = posts[index].userName
            viewUser.userIDsample = posts[index].userID
            viewUser.profileURL = posts[index].profileURL
